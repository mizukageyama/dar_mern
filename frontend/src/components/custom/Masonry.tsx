const Masonry = () => {
  return (
    <section id="testimonies" className="py-20 text-slate-900">
      <div className="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
        <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
          <div className="mb-12 space-y-5 md:mb-16 md:text-center">
            <h1 className="mb-3 text-3xl font-semibold text-slate-900 md:text-center md:text-5xl">
              Notes
            </h1>
          ...
          <ul className="space-y-8">
            <li className="text-sm leading-6">
              <div className="relative group">
                <div className="absolute transition rounded-lg opacity-25 blur duration-400 group-hover:opacity-100 group-hover:duration-200"></div>
                <a
